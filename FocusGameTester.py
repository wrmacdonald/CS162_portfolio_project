...
class TestFocusGame(unittest.TestCase):
    ...
    def test2(self):
        game = FocusGame.FocusGame(("PlA-ah", "Red"), ("Ble-ah", "Green"))
        game.move_piece("PlA-ah", (0, 0), (0, 1), 1)
        # game.show_board()
        self.assertEqual(game.move_piece("Ble-ah", (0, 2), (0, 3), 1), "successfully moved")

    def test3(self):
        game = FocusGame.FocusGame(("PlayerA", "Red"), ("PlayerB", "Green"))
        game.move_piece("PlayerA", (2, 1), (2, 0), 1)
        game.move_piece("PlayerB", (2, 2), (1, 2), 1)
        game.move_piece("PlayerA", (2, 0), (0, 0), 2)
        game.move_piece("PlayerB", (1, 2), (3, 2), 2)
    ...
    def test1CR(self):
        game = FocusGame.FocusGame(("PlayerA", "Red"), ("PlayerB", "Gre"))
        game.move_piece("PlayerA", (2, 1), (2, 0), 1)
        game.move_piece("PlayerB", (2, 2), (1, 2), 1)
        game.move_piece("PlayerA", (2, 0), (0, 0), 2)
        game.move_piece("PlayerB", (1, 2), (3, 2), 2)
    ...
    def test3CR(self):
        ...
        game.move_piece("PlayerA", (5, 2), (5, 3), 1)
        game.move_piece("PlayerB", (5, 4), (5, 3), 1)
        self.assertEqual(game.show_captured("PlayerB"), 3)
    ...
    def test6CR(self):
        ...
        game.move_piece("PlayerA", (4, 1), (4, 0), 1)
        game.move_piece("PlayerB", (3, 3), (5, 3), 2)
        self.assertEqual(game.show_captured("PlayerB"), 4)
    ...
    def test7CR(self):
        ...
        game.move_piece("PlayerB", (1, 4), (2, 4), 1)
        game.move_piece("PlayerA", (4, 0), (5, 0), 1)
        game.move_piece("PlayerB", (2, 4), (4, 4), 2)
        self.assertEqual(game.show_captured("PlayerB"), 6)

    def test8CR(self):
        game = FocusGame.FocusGame(("PlayerA", "Pink"), ("PlayerB", "Magenta"))
        game.move_piece("PlayerA", (2, 1), (2, 0), 1)
        game.move_piece("PlayerB", (2, 2), (1, 2), 1)
        game.move_piece("PlayerA", (2, 0), (0, 0), 2)
        game.move_piece("PlayerB", (1, 2), (3, 2), 2)
